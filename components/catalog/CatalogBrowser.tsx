...
/**
 * Full catalog interactive shell. Owns filter state (category, search, sort)
 * and infinite scroll. The catalog is a single global dataset — no region
 * awareness, no cold/warm phases.
 */
export function CatalogBrowser({
  ...
  useEffect(() => {
    // Skip mount: the server already gave us the correct first page.
  ...
  return (
    <div className="min-h-screen bg-page">
      {/* ── Sticky site header (owns search) ─────────────────────────────── */}
      <SiteHeader
        search={search}
        onSearch={setSearch}
      />
